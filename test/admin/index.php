...
*/
  ...
  session_start();
   if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'processLogin')) {
		if($HTTP_POST_VARS['login'] == SITE_MANAGEMENT_USERNAME && $HTTP_POST_VARS['password'] == SITE_MANAGEMENT_PASSWORD) {
			$_SESSION["sessionUser"] = $HTTP_POST_VARS['login'];
		}
	}

   if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'processLogout')) {
